...
class compare():
	...
	def BestAndPoorest(self, MPI, param):
		print("bestandpoorest_1")
		print(MPI.COMM_WORLD.Get_rank(), self.networkFitness)
		...
		'''
		minIndex = parallel.parallelDistributed(MPI, param).getMin(self.networkFitness)
		maxIndex = parallel.parallelDistributed(MPI, param).getMax(self.networkFitness)
		print("bestandpoorest_2")
		print(MPI.COMM_WORLD.Get_rank(), self.networkFitness)
	...
	def genFitness(self, data, param, MPI):


		# Get the ranks with the best and worst fitness
		maxIndex, minIndex = self.BestAndPoorest( MPI, param)
		...
		procRank = parallel.parallelDistributed(MPI, param).getCommRank()
